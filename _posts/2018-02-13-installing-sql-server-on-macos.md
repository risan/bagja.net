...
image_thumb: img/installing-sql-server-on-macos/featured-thumb.jpg
image:
  path: img/installing-sql-server-on-macos/og.jpg
  width: 1200
  height: 782
---
...
![Docker is running](img/installing-sql-server-on-macos/docker-is-running.png)
